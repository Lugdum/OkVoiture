...
const BookingForm: React.FC<BookingFormProps> = ({listingId}) => {
    ...
    return (
      <form onSubmit={(e) => submitBooking(e, listingId)} className={`flex flex-col items-center`}>
        ...
        {errorMessageBooking? <div className={`text-${errorMessageBooking === "Your booking has been added!"? "black":"red"}-500 font-bold text-center`}>{errorMessageBooking}</div> : ""}
